...
import { PhFlask, PhPlay, PhPlus } from '@phosphor-icons/vue'
...
<template>
  <section>
    <header class="page-header"><div><p class="page-kicker">Release evidence</p><h1>Test suites</h1><p>Versioned golden cases, approved lookup snapshots and asynchronous execution evidence.</p></div><button class="primary-button" :disabled="!decisionKey" @click="editing=!editing"><PhPlus :size="15"/>New suite revision</button></header>
